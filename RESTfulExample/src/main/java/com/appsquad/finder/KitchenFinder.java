...
public class KitchenFinder {
	...
	public static ArrayList<Integer> getKitchenIds( ArrayList<OrderItems> orderItems, String mealType,
			String deliveryDay, String area){
		Set<Integer> kitchenIdSet = new HashSet<Integer>();
		
		for(OrderItems  items : orderItems){
			ArrayList<Integer> selectedKitchenIds = getServableKitchens(items.cuisineId,items.itemCode, items.quantity, mealType, deliveryDay, area);
			items.setKitchenIdlist(selectedKitchenIds); 
			System.out.println("ITEMCODE:: "+items.itemCode+ " KITCHENS: "+items.getKitchenIdlist());
			for(Integer kitchenId : items.getKitchenIdlist()){
				kitchenIdSet.add(kitchenId);
			}	
		}
	...
	public static ArrayList<Integer> getServableKitchens(int cuisineId, String itemCode, int quantity, 
		...
		try {
			SQL:{
					...
					try {
						...
						//Retrieving kitchen and respective item stock from DB
		...
		boolean servableByAllKitchen = false, servableByMultiKitchen = false, isKitchenFound = false,servableBySingleKitchen = false;
